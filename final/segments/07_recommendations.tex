...
Regime 0 (Accommodation), the average spread is $-0.19$ percentage
...
magnitudes are roughly twice as large in the accommodation regime as
in the tightening regime, which means the model's directional
forecasts are materially higher-quality inside Regime 0
(\texttt{target\_lag1}'s SHAP value 0.689) than inside Regime 1
(0.344).
